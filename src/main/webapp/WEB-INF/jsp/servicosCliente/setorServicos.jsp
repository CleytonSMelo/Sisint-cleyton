...
<tags:layout>
    ...
    <jsp:body>
        <div class="panel painel-sisint">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Serviços Solicitados pela Unidade / Setor: ${usuarioLogado.usuario.setor.nome}</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <table class="table table-bordered tabela">
                        ...
                        <c:forEach items="${servicos}" var="servico">
                            <tr>
                                ...
                                <td><a title="Detalhes" href="${linkTo[ServicosClienteController].detalhes}?id=${servico.id}"><i class="fa fa-eye fa-lg" aria-hidden="false"></i></a>
                                    <a title="Editar" href="${linkTo[ServicosClienteController].editar}?id=${servico.id}"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
                                    <c:if test="${usuarioLogado.isAdmin()}">
                                        <a title="Log do serviço" href="${linkTo[ServicosClienteController].logServico}?id=${servico.id}">
